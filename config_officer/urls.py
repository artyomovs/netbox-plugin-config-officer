...
urlpatterns = [
    ...
    path(
        "templates/delete/",
        views.TemplateBulkDeleteView.as_view(),
        name="templates_bulk_delete",
    ),
    path("templates/<int:pk>", views.TemplateView.as_view(), name="template"),
    path(
        "templates/<int:pk>/edit",
        views.TemplateEditView.as_view(),
        name="template_edit",
    ),
    path(
    ...
    # Service rules
    path(
        "service_rules/", views.ServiceRuleListView.as_view(), name="service_rules_list"
    ),
    path(
        "service_rules/add/",
        views.ServiceRuleCreateView.as_view(),
        name="service_rule_add",
    ),
    path(
    ...
    path(
        "service_mapping/",
        views.ServiceMappingListView.as_view(),
        name="service_mapping_list",
    ),
    path(
        "service_mapping/add/",
        views.ServiceMappingCreateView.as_view(),
        name="service_mapping_add",
    ),
    path(
        "service_mapping/assign", views.ServiceAssign.as_view(), name="assign_service"
    ),
    path(
        "service_mapping/remove",
        views.ServiceDetach.as_view(),
    ...
    path(
        "running_config/<slug:hostname>/", views.running_config, name="running_config"
    ),
]
